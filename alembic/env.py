...
def to_sync_sqlalchemy_url(url: str) -> str:
    """Convert runtime DB URL into a synchronous SQLAlchemy URL for Alembic."""
    sync_url = re.sub(r"^postgresql\+asyncpg:", "postgresql+psycopg2:", url)
...
config.set_main_option("sqlalchemy.url", to_sync_sqlalchemy_url(database_url))
